...
from tensorflow.python.keras.layers import Input, Dense, Embedding, Concatenate, Flatten, Lambda
...
def Base(feature_dim_dict, seq_feature_list, embedding_size=8, hist_len_max=16,
